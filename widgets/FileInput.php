<?php
namespace fabiomlferreira\filemanager\widgets;
 ...
 * More samples of usage see on github: https://github.com/fabiomlferreira/yii2-file-manager
 *
 * @package fabiomlferreira\filemanager\widgets
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/fabiomlferreira/yii2-file-manager/views/file/modal.php', [
