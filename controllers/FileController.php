...
namespace fabiomlferreira\filemanager\controllers;

use fabiomlferreira\filemanager\models\MediafileSearch;
use Yii;
...
class FileController extends Controller
{
    ...
    {
        $this->layout = '@vendor/fabiomlferreira/yii2-file-manager/views/layouts/main';
